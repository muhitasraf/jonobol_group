                    ...
                    <div class="card card-info card-outline">
                        <?php if ($perm->hasPerm(['show-employee','edit-employee'])):?>
                            <ul class="nav nav-tabs p-1" id="custom-content-above-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="general_info-tab" data-toggle="pill" href="#general_info" role="tab" aria-controls="general_info" aria-selected="false">General</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="bangla_info-tab" data-toggle="pill" href="#bangla_info" role="tab" aria-controls="bangla_info" aria-selected="true">Bangla Info</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="custom-content-above-tabContent">
                                                        ...
                                                        <div class="card card-primary">
                                                            <div class="card-body-x p-1">
                                                                ...
                                                                <div class="form-group mb-2">
                                                                    ...
                                                                    <?php
                                                                    echo form_select('OffDay',['friday'=>'Friday','saturday'=>'Saturday','sunday'=>'Sunday','monday'=>'Monday','tuesday'=>'Tuesday','wednesday'=>'Wednesday','thursday'=>'Thursday'], $employee_info->OffDay,'class="form-control form-control-sm ml-1" id="OffDayID"');
                                                                    ?>
                                                                </div>                                                          
                                                                <!--div class="form-group mb-2">
                                                                    ...
                                                                    <div class="row p-1">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <div class="form-group mb-2">
                                                                                ...
                                                                                <input type="text" class="form-control form-control-sm" placeholder="Enter Name" id="EmployeeName" name="EmployeeName" value="<?php echo $employee_info->EmployeeName; ?>">
                                                                            </div>
                                                                        </div>                                                               
                                                                    </div>
                                                                    <div class="row p-1">                                                                    
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group mb-2">
                                                                                ...
                                                                                <input type="text" class="form-control form-control-sm" placeholder="Enter Father Name" id="FatherName" name="FatherName" value="<?php echo $employee_info->FatherName; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="MotherName">Mother Name</label>
                                                                                <input type="text" class="form-control form-control-sm" placeholder="Enter Mother Name" id="MotherName" name="MotherName" value="<?php echo $employee_info->MotherName; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="SpouseName">Spouse Name</label>
                                                                                <input type="text" class="form-control form-control-sm" placeholder="Enter Spouse Name" id="SpouseName" name="SpouseName" value="<?php echo $employee_info->SpouseName; ?>">
                                                                            </div>
                                                                        </div>                                                                    
                                                                    </div>
                                                                    <!-- /.card-body -->
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body-x p-1">
                                                                        ...
                                                                        <div class="form-group mb-2">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-sm" name="identification" id="identification" placeholder="Personnel Remarks" value="<?php echo $employee_info->identification; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <!-- /.card-body -->
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group mb-2">
                                                                                ...
                                                                                <input type="text" class="form-control form-control-sm" name="name_bangla" id="name_bangla" placeholder="আপনার নাম লিখুন" value="<?php echo $employee_info->name_bangla; ?>">
                                                                            </div> 
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="fathers_name_bangla">পিতার নামঃ</label>
                                                                                <input type="text" class="form-control form-control-sm" name="fathers_name_bangla" id="fathers_name_bangla" placeholder="আপনার পিতার নাম লিখুন" value="<?php echo $employee_info->fathers_name_bangla; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="mothers_name_bangla">মাতার নামঃ</label>
                                                                                <input type="text" class="form-control form-control-sm" name="mothers_name_bangla" id="mothers_name_bangla" placeholder="আপনার মাতার নাম লিখুন" value="<?php echo $employee_info->mothers_name_bangla; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="spouse_name_bangla">স্বামী/স্ত্রীর নামঃ</label>
                                                                                <input type="text" class="form-control form-control-sm" name="spouse_name_bangla" id="spouse_name_bangla" placeholder="আপনার স্বামী/স্ত্রীর নাম লিখুন" value="<?php echo $employee_info->spouse_name_bangla; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="permanent_address_bangla">স্থায়ী ঠিকানা</label>
                                                                                <?php echo form_textarea('PermanentAddressLocal',$employee_info->permanent_address_bangla, $attribute='class="form-control keyboard" rows="2" placeholder="স্থায়ী ঠিকানা" name="permanent_address_bangla" id="permanent_address_bangla" value="<?php echo $employee_info->permanent_address_bangla; ?>" data-toggle="modal" data-target="#myModal" autocomplete="off"'); ?>
                                                                            </div>                                                                    
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="present_address_bangla">বর্তমান ঠিকানা</label>
                                                                                <?php echo form_textarea('PermanentAddressLocal',$employee_info->present_address_bangla, $attribute='class="form-control keyboard" rows="2" placeholder="বর্তমান ঠিকানা" name="present_address_bangla" id="present_address_bangla" value="<?php echo $employee_info->present_address_bangla; ?>" data-toggle="modal" data-target="#myModal" autocomplete="off"'); ?>
                                                                            </div>                                                                    
                                                                        </div>                                                                    
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body-x p-1">                                                                
                                                                    <div class="form-group mb-2">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-sm" name="weight" id="weight" placeholder="ওজন" value="<?php echo $employee_info->weight; ?>">
                                                                    </div>
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="height">উচ্চতা</label>
                                                                        <input type="text" class="form-control form-control-sm" name="height" id="height"  placeholder="উচ্চতা" value="<?php echo $employee_info->height; ?>">
                                                                    </div>
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="bodyCapability">দৈহিক সক্ষমতা</label>
                                                                        <input type="text" class="form-control form-control-sm" name="bodyCapability" id="bodyCapability" placeholder="দৈহিক সক্ষমতা" value="<?php echo $employee_info->body_capability; ?>">
                                                                    </div>
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="noochild">সন্তান সংখ্যা</label>
                                                                        <input type="number" class="form-control form-control-sm" name="noochild" id="noochild" placeholder="সন্তান সংখ্যা" value="<?php echo $employee_info->child_number_bangla; ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                ...
                                                                                <input type="text" class="form-control form-control-sm" class="select2 form-control form-control-sm" name="rf1name" id="rf1name" placeholder="নামঃ" value="<?php echo $employee_info->intro_1_name; ?>">
                                                                            </div> 
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf1v">গ্রাম</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf1v" id="rf1v" placeholder="গ্রাম" value="<?php echo $employee_info->intro_1_vill; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf1po">ডাকঘর</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf1po" id="rf1po" placeholder="ডাকঘর" value="<?php echo $employee_info->intro_1_post; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf1ps">থানা</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf1ps" id="rf1ps" placeholder="থানা" value="<?php echo $employee_info->intro_1_thana; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf1d">জেলা</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf1d" id="rf1d" placeholder="জেলা" value="<?php echo $employee_info->intro_1_dist; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf1m">মোবাইল নং</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf1m" id="rf1m" placeholder="মোবাইল নং" value="<?php echo $employee_info->intro_1_phone; ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                ...
                                                                                <input type="text" class="form-control form-control-sm" class="select2 form-control form-control-sm" name="rf2name" id="rf2name" placeholder="নামঃ" value="<?php echo $employee_info->intro_2_name; ?>">
                                                                            </div> 
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf2v">গ্রাম</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf2v" id="rf2v" placeholder="গ্রাম" value="<?php echo $employee_info->intro_2_vill; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf2po">ডাকঘর</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf2po" id="rf2po" placeholder="ডাকঘর" value="<?php echo $employee_info->intro_2_post; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf2ps">থানা</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf2ps" id="rf2ps" placeholder="থানা" value="<?php echo $employee_info->intro_2_thana; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf2d">জেলা</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf2d" id="rf2d" placeholder="জেলা" value="<?php echo $employee_info->intro_2_dist; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group mb-2">
                                                                                <label class="m-0" for="rf2m">মোবাইল নং</label>
                                                                                <input type="text" class="form-control form-control-sm" name="rf2m" id="rf2m" placeholder="মোবাইল নং" value="<?php echo $employee_info->intro_2_phone; ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="input-highlight">
                                                                        <?php
                                                                            if(isset($employee_info->DOJ)){
                                                                                echo form_input('DOJ','text',date_conversion('d-m-Y', $employee_info->DOJ),'class="form-control form-control-sm" id="DOJ" autocomplete="off" ');
                                                                            }else{
                                                            ...
                                                            <div class="card-body-x p-1">
                                                                ...
                                                                <div class="form-group mb-2">
                                                                    <div class="input-group">
                                                                        <div class="form-group mb-2">
                                                                            ...
                                                                            <?php
                                                                                $ot_array = array('0'=>'Select OT','1'=>'Active','0'=>'DeActive');
                                                                ...
                                                                <div class="form-group mb-2">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="form-check form-check-inline">
                                                                            <?php
                                                                                $ot_array = array('0'=>'Select Holiday Bonus','1'=>'Active','0'=>'DeActive');
                                ...
                                <div class="tab-pane fade" id="bangla_info" role="tabpanel" aria-labelledby="bangla_info-tab">
                                    <form action="<?php echo route("employee/update/".$employee_info->id);?>" class="role" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="_method" value="PATCH">
                                        <?php echo csrf_field();?>
                                        <div class="card">
                                            <div class="card-group pt-1"><!-- card-deck -->
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="card card-primary">
                                                        <div class="card-body-x p-1">
                                                            <div class="form-group mb-0">
                                                                <label class="m-0" for="inputPhoto">ছবি</label>
                                                                <div class="text-center">
                                                                    <?php
                                                                    $path = "uploads/images/";
                                                                    $employee_photo = $path."employee/".$employee_info->EmployeePhoto;
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="card">
                                                                <div class="card-body-x p-1">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="employeeName">নামঃ</label>
                                                                        <input type="text" class="form-control form-control-sm" name="employeeName" id="employeeName" placeholder="আপনার নাম লিখুন" value="">
                                                                    </div>
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="FatherName">পিতার নামঃ</label>
                                                                        <input type="text" class="form-control form-control-sm" name="FatherName" id="FatherName" placeholder="আপনার পিতার নাম লিখুন" value="">
                                                                    </div>
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="MotherName">মাতার নামঃ</label>
                                                                        <input type="text" class="form-control form-control-sm" name="MotherName" id="MotherName" placeholder="আপনার মাতার নাম লিখুন" value="">
                                                                    </div>
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="SpouseName">স্বামী/স্ত্রীর নামঃ</label>
                                                                        <input type="text" class="form-control form-control-sm" name="SpouseName" id="SpouseName" placeholder="আপনার স্বামী/স্ত্রীর নাম লিখুন" value="">
                                                                    </div>
                                                                </div>
                                                                <!-- /.card-body -->
                                                            </div>
                                                ...
                                                <div class="row col-sm-12">
                                                    <div class="col-sm-8">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body-x p-1">
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="PermanentAddress">স্থায়ী ঠিকানা</label>
                                                                    <textarea type="text" class="form-control form-control-sm" rows="3" placeholder="থায়ী ঠিকানা" name="PermanentAddress" id="PermanentAddress" value=""></textarea>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group mb-2">
                                                                            <label class="m-0" for="PermanentPO">ডাকঘর</label>
                                                                            <input type="text" class="form-control form-control-sm" class="form-control form-control-sm" name="PermanentPO" id="PermanentPO" placeholder="ডাকঘর">                                                                            
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group mb-2">
                                                                            <label class="m-0" for="PermanentPS">থানা</label>
                                                                            <input type="text" class="form-control form-control-sm" class="form-control form-control-sm" name="PermanentPS" id="PermanentPS" placeholder="থানা">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group mb-2">
                                                                            <label class="m-0" for="PermanentDist">জেলা</label>
                                                                            <input type="text" class="form-control form-control-sm" class="select2 form-control form-control-sm" name="PermanentDist" id="PermanentDist" placeholder="জেলা">
                                                                        </div> 
                                                                    </div>
                                                                </div>                                                                                                                                   
                                                            </div>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header p-1">
                                                                ...
                                                                <div class="card-tools">
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="checkbox" value="1" id="is_address_same" name="is_address_same" <?php echo ($address_info[0]->is_address_same==1 ? 'checked' : '');?>>
                                                                        <label class="form-check-label" for="is_address_same">স্থায়ী ও বর্তমান ঠিকানা একই</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card-body-x p-1" id="sameAsPresent">
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="PresentAddress">বর্তমান ঠিকানা</label>
                                                                    <textarea type="text" class="form-control form-control-sm" rows="3" placeholder="বর্তমান ঠিকানা" name="PresentAddress" id="PresentAddress" value=""></textarea>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group mb-2">
                                                                            <label class="m-0" for="PresentPO">ডাকঘর</label>
                                                                            <input type="text" class="form-control form-control-sm" class="form-control form-control-sm" name="PresentPO" id="PresentPO" placeholder="ডাকঘর">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group mb-2">
                                                                            <label class="m-0" for="PresentPS">থানা</label>
                                                                            <input type="text" class="form-control form-control-sm" class="form-control form-control-sm" name="PresentPS" id="PresentPS" placeholder="থানা">    
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group mb-2">
                                                                            <label class="m-0" for="PresentDist">জেলা</label>
                                                                            <input type="text" class="form-control form-control-sm" class="select2 form-control form-control-sm" name="PresentDist" id="PresentDist" placeholder="জেলা">
                                                                        </div> 
                                                                    </div>
                                                                </div>                                                                
                                                            </div>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="row card-body-x p-1">
                                                                <div class="col-sm-3">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="exp">অভিজ্ঞতা</label>
                                                                        <input type="text" class="form-control form-control-sm" class="select2 form-control form-control-sm" name="exp" id="exp" placeholder="সময়/মাস" value="">
                                                                    </div> 
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="factoryName">ফ্যাক্টরী নাম</label>
                                                                        <input type="text" class="form-control form-control-sm" name="factoryName" id="factoryName" placeholder="ফ্যাক্টরী নাম" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="jobPost">পদবী</label>
                                                                        <input type="text" class="form-control form-control-sm" name="jobPost" id="jobPost" placeholder="পদবী" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="jobTime">কার্যকাল</label>
                                                                        <input type="text" class="form-control form-control-sm" name="jobTime" id="jobTime" placeholder="কার্যকাল" value="">
                                                                    </div>
                                                                </div>
                                                            </div> <!-- /.card-body -->
                                                        </div> <!-- /.card -->
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header p-1">
                                                                নিয়োগ সংক্রান্ত তথ্য
                                                            </div>
                                                            <div class="row card-body-x p-1">
                                                                <div class="col-sm-3">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="enrollPost">পদবী</label>
                                                                        <input type="text" class="form-control form-control-sm" class="select2 form-control form-control-sm" name="enrollPost" id="enrollPost" placeholder="পদবী" value="">
                                                                    </div> 
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="labourClass">শ্রমিকের শ্রেণী</label>
                                                                        <input type="text" class="form-control form-control-sm" name="labourClass" id="labourClass" placeholder="শ্রমিকের শ্রেণী" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="jobGrade">গ্রেড</label>
                                                                        <input type="text" class="form-control form-control-sm" name="jobGrade" id="jobGrade" placeholder="গ্রেড" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <div class="form-group mb-2">
                                                                        <label class="m-0" for="salary">মূল বেতন</label>
                                                                        <input type="text" class="form-control form-control-sm" name="salary" id="salary" placeholder="মূল বেতন" value="">
                                                                    </div>
                                                                </div>
                                                            </div> <!-- /.card-body -->
                                                        </div> <!-- /.card -->                                                            
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="card">
                                                            <div class="card-body-x p-1">
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="DOB">জন্ম তারিখ</label>
                                                                    <div class="input-group">
                                                                        <?php
                                                                            echo form_input('DOB','text',date_conversion('d-m-Y', $employee_info->DOB), $attribute='class="form-control form-control-sm form_date" autocomplete="off" id="DOB" ');
                                                                        ?>
                                                                ...
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="DOB">বয়স</label>
                                                                    <div class="input-group">
                                                                        <?php
                                                                            $age = date_diff(date_create(), date_create($employee_info->DOB));
                                                                            $age = $age->format("%Y Y,%M M,%d D");
                                                                ...
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="gender">লিঙ্গ</label>
                                                                    <select class="form-control form-control-sm" name="gender" id="gender">
                                                                        <option selected value="1">-চয়ন করুন-</option>
                                                                        <option value="পুরুষ">পুরুষ</option>
                                                                        <option value="মহিলা">মহিলা</option>                                                                            
                                                                    </select>
                                                                </div>
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="religion">ধর্ম</label>
                                                                    <select class="form-control form-control-sm" name="religion" id="religion">
                                                                        <option selected value="1">-চয়ন করুন-</option>
                                                                        <option value="ইসলাম">ইসলাম</option>
                                                                        <option value="হিন্দু">হিন্দু</option>
                                                                        <option value="বৈধ">বৈধ</option>
                                                                        <option value="খ্রিস্টান">খ্রিস্টান</option>
                                                                        <option value="ধর্ম নিরপেক্ষ">ধর্ম নিরপেক্ষ</option>
                                                                        <option value="অন্যান্য">অন্যান্য</option>                                                                                                                                                        
                                                                    </select>
                                                                </div>
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="nationality">জাতীয়তা</label>
                                                                    <input type="text" class="form-control form-control-sm" name="nationality" id="nationality" placeholder="জাতীয়তা" value="বাংলাদেশী">
                                                                </div>
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="maritualStatus">বৈবাহিক অবস্থ্যা</label>
                                                                    <select class="form-control form-control-sm" name="maritualStatus" id="maritualStatus">
                                                                        <option selected value="1">-চয়ন করুন-</option>
                                                                        <option value="অবিবাহীত">অবিবাহীত</option>
                                                                        <option value="বিবাহীত">বিবাহীত</option>
                                                                ...
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="bloodGroup">রক্তের গ্রুপ</label>
                                                                ...
                                                                <div class="form-group mb-2">
                                                                    ...
                                                                    <label class="m-0" for="identyMark">সনাক্তকরণ চিহ্ন</label>
                                                                    <input type="text" class="form-control form-control-sm" name="identyMark" id="identyMark" placeholder="সনাক্তকরণ চিহ্ন" value="">
                                                                </div>
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="mobile">মোবাইল নম্বর</label>
                                                                    <input type="text" class="form-control form-control-sm" name="mobile" id="mobile"  placeholder="মোবাইল নম্বর" value="">
                                                                </div>
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="emergencyContact">জরুরী মোবাইল নম্বর</label>
                                                                    <input type="text" class="form-control form-control-sm" name="emergencyContact" id="emergencyContact" placeholder="জরুরী মোবাইল নম্বর" value="">
                                                                </div>
                                                                <div class="form-group mb-2">
                                                                    <label class="m-0" for="noochild">সন্তান সংখ্যা</label>
                                            ...
                                            <div class="card-footer">
                                                <?php if ($can):?>
                                                    <input type="submit" class="btn btn-info float-right" name="bangla_info" value="Save" />
                                                <?php endif;?>
                                            </div>
                                        </div>
                                    </form>
