            ...
            <div class="col-sm-12 salary-sheet">
                <table class="table table-striped table-bordered dataTable FixedHeader">
                    ...
                    <tbody>
                        ...
                        $tot_food = 0;$tot_stamp = 0;$tot_tot_deduc = 0;$tot_pay_sal = 0;$tot_attn_bonus = 0;$tot_arear = 0;$tot_pay = 0;
                        foreach($employee_info as $key => $row):
                            ...
                            if ($section_name != $section_name_old) { 
                                ...
                                if ( $key != 0 ) {
                                    ...
                                    $tot_food += $tot_sec_food;$tot_stamp += $tot_sec_stamp;$tot_tot_deduc += $tot_sec_tot_deduc;$tot_pay_sal += $tot_sec_pay_sal;$tot_attn_bonus += $tot_sec_attn_bonus;$tot_arear += $tot_sec_arear;$tot_pay += $tot_sec_pay;
                                } ?>
