...
<script>
    $(function () {
        $('.btn-get-data').on('click',function () {
            ...
            let url = "<?php echo route('reports/payment/monthly_ot_payment_result'); ?>";
            $.get(url,{StaffCategory, Month, Year, cbCode, cbName, cbDoj, cbDesignation, cbSection, cbDepartment,cbStaffCat },function (data) {
