                ...
                <table class="table table-striped table-bordered dataTable FixedHeader">
                    <thead>                        
                        <tr class="table-success">
                            ...
                            <th>OT Rate<?php $serial+=1;?></th>
                            <th>Total OT Hour<?php $serial+=1;?></th>
                            <th>Total OT Payment<?php $serial+=1;?></th>
                            <th class="rotated-text"><div><span>Attendance Bonus</span></div><?php $serial+=1;?></th>
                            <th>Arear<?php $serial+=1;?></th>
                            <th>Total Payable<?php $serial+=1;?></th>
                    ...
                    <tbody>
                        ...
                        $tot_food = 0;$tot_stamp = 0;$tot_tot_deduc = 0;$tot_pay_sal = 0;$tot_ot_rate = 0;$tot_tot_ot_hour = 0;
                        ...
                        foreach($employee_info as $key => $row):
                            ...
                            if ($section_name != $section_name_old) { 
                                ...
                                if ( $key != 0 ) {
                                    ?><tr class ='row_index table-warning'>
                                        <td colspan="<?php echo $serial-19;?>" style="font-weight:bold;"><?php echo 'Department : '.$dept.'<br/> Section : '.$prev_rowspan;?></td>
                                    ...
                                    $tot_food += $tot_sec_food;$tot_stamp += $tot_sec_stamp;$tot_tot_deduc += $tot_sec_tot_deduc;$tot_pay_sal += $tot_sec_pay_sal;$tot_ot_rate += $tot_sec_ot_rate;$tot_tot_ot_hour += $tot_sec_tot_ot_hour;
                                ...
                                $tot_sec_food = 0;$tot_sec_stamp = 0;$tot_sec_tot_deduc = 0;$tot_sec_pay_sal = 0;$tot_sec_ot_rate = 0;$tot_sec_tot_ot_hour = 0;
                            ...
                            $tot_sec_food += $food;$tot_sec_stamp += $stamp;$tot_sec_tot_deduc += $deduction;$tot_sec_pay_sal += $payable;$tot_sec_ot_rate += $OT_PER_HOUR;$tot_sec_tot_ot_hour += $OT_HOUR;
                            ...
                            <tr>
                                <?php
                                    /*if($prev_rowspan!=$row['Section']){       
                                        ?>
                                            <td rowspan="<?php echo $tr_rowspan;?>"><?php echo $row['Section'];?></td>
                                        <?php 
                                    }*/
                                ?>
                                <td><?php echo ++$i; ?></td>
                        ...
                        <tr class="table-info">
                            <td colspan="<?php echo $serial-19;?>" style="font-weight:bold;">Total</td>
