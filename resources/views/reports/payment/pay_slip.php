                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <?php
                                                echo form_input('Month','text',date('F'),'class="form-control form-control-sm form_month" autocomplete="off" id="Month" required');
                                                ?>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <?php
                                                echo form_input('Year','text',date('Y'),'class="form-control form-control-sm form_year" autocomplete="off" id="Year" required');
                                                ?>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(function () {
        $('.btn-get-data').on('click',function (e) {
            ...
            let Month = $('#Month').val();
            let Year = $('#Year').val();
            let url = "<?php echo route('reports/payment/pay_slip_result'); ?>";
            $.get(url,{EmployeeCode:EmployeeCode,Department:Department, Designation:Designation, Section:Section, Month:Month, Year:Year},function (data) {
