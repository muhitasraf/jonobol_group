...
<script>
    $(function () {
        $('.btn-get-data').on('click',function () {
            ...
            $('div.spinner').show();
            let Month = $('#Month').val();
            let Year = $('#Year').val();let cbCode = $('#cbCode:checked').val();
            ...
            let url = "<?php echo route('reports/payment/monthly_security_salary_result'); ?>";
            $.get(url,{Month, Year , cbCode, cbName, cbDoj, cbDesignation, cbSection, cbDepartment,cbStaffCat},function (data) {
