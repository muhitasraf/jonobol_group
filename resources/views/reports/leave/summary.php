                    ...
                    <div class="col-md-9">
                        ...
                        <div class="card card-info-x card-outline print-employee-info d-print-block">
                            <div class="card-body-x p-3">
                                <button class="btn btn-info float-right btn-sm ml-3 btn-export d-print-none">
...
<script>
    $(function () {
        $('.btn-get-data').on('click',function () {
            ...
            let url = "<?php echo route('reports/leave/summary_result'); ?>";
            $.get(url,{FromDate:FromDate,ToDate:ToDate},function (data) {
