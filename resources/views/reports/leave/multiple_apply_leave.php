                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="tab-content" id="custom-content-above-tabContent">
                            <div class="tab-pane fade show active" id="step_one" role="tabpanel" aria-labelledby="step-one">
                                <div class="card">
                                    <span class="bg-info pl-2">Multiple Leave Entry</span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 mt-4">
                                                            <div class="form-check form-check-inline">
                                                                <h5>Multiple Leave Entry Process</h5>
                                    ...
                                    <div class="card-group pt-1"><!-- card-deck -->
                                        ...
                                        <div class="col-sm-9">
                                            <div class="card card-primary">
                                                <!-- /.card-body -->
                                                <div class="card card-primary">
                                                    <span class="bg-info text-center">Employee Information</span>
...
<script>
    ...
    $('.all_employee_cb').trigger('change');
     ...
     $('.go-step-three').one('click',function () {
        ...
        let url = "<?php echo route('multiple_apply_leave/multiple_apply_leave'); ?>";
    ...
    $('.btn-save').one('click',function () {
        ...
        let FromDate = [];
        $.each($('.FromDate'),function(i) {
            FromDate[i] = $(this).val();
        });
        FromDate = JSON.stringify(FromDate);
        
        let ToDate = [];
        $.each($('.ToDate'),function(i) {
            ToDate[i] = $(this).val();
        });
        ...
        let LeaveType = [];
        $.each($('.LeaveType'),function(i) {
            LeaveType[i] = $(this).val();
        });
        ...
        let url = "<?php echo route('multiple_apply_leave/multiple_leave_store'); ?>";
