                            ...
                            <div class="card card-info card-outline">
                                <div class="card-body-x p-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" name="employee_code" class="form-control form-control-sm EmployeeCode" id="employee_code" value="">
                                    </div>                                    
                                    <div class="row">
                                        <div class="col-sm-6">
...
<script>
    $(function () {
        $('.btn-get-data').on('click',function () {
            ...
            let url = "<?php echo route('reports/employee_leave_result'); ?>";
