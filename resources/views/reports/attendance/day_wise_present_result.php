<?php
    ...
    if ($employee_info):
       $header = [
               'Date', 'Employee Code', 'Employee Name', 'Department', 'Designation', 'Section','DOJ', 'Shift In Time',
                ...
                <div class="col-sm-12">
                    ...
                    <tbody>
                        <?php foreach($employee_info as $key => $row):
                            ...
                            $PunchIN = date_conversion('h:i A',$row['PunchIN']);
                            $PunchOUT = date_conversion('h:i A',$row['PunchOUT']);
