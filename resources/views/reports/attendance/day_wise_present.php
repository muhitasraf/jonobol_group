                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <div class="form-group mb-1">
                                                ...
                                                <?php
                                                echo form_input('OnDate','text',date('d-m-Y'),'class="form-control form-control-sm form_date OnDate" autocomplete="off" id="OnDate"');
                                                ?>
                                            </div>
...
<script>
    $(function () {
        $('.btn-get-data').on('click',function () {
            ...
            let url = "<?php echo route('reports/attendance/day_wise_present_result'); ?>";
