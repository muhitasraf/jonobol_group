                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <div class="form-group mb-1">
                                                ...
                                                <?php
                                                echo form_input('OnDate','text',date('d-m-Y'),'class="form-control form-control-sm form_date OnDate" autocomplete="off" id="OnDate" readonly required');
                                                ?>
                                            </div>
                                            <div class="form-group mb-1">
                                            ...
                                            <div class="form-group mb-1">
                                                <label class="m-0" for="ToDate">Employee Code</label>
                                                <?php
                                                echo form_input('EmployeeCode','text',null,'class="form-control form-control-sm" autocomplete="off" id="EmployeeCode"');
                                                ?>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(function () {
        $('.btn-get-data').on('click',function () {
            ...
            let url = "<?php echo route('reports/attendance/day_wise_absent_result'); ?>";
