                                ...
                                <div class="card-body-x p-1">
                                    ...
                                    <div class="row">
                                        <div class="form-check-inline">
                                            ...
                                            <div class="form-check-inline">
                                                <input class="form-check-input cbStaffCat" type="checkbox" id="cbStaffCat" value="1" name="cbStaffCat">
                                    ...
                                    <div class="row">
                                        <div class="form-check-inline">
                                            <div class="form-check-inline ml-3">
                                                <input class="form-check-input Present" type="checkbox" id="cbPresent" value="1" name="cbPresent" checked>
                                                <label class="form-check-label" for="cbPresent">Present</label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input cbAbsent" type="checkbox" id="cbAbsent" value="1" name="cbAbsent" checked>
                                                <label class="form-check-label" for="cbAbsent">Absent</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-check-inline">
                                            <div class="form-check-inline ml-3">
                                                <input class="form-check-input Late" type="checkbox" id="cbLate" value="1" name="cbLate" checked>
                                                <label class="form-check-label" for="cbLate">Late</label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input cbOT" type="checkbox" id="cbOT" value="1" name="cbOT" checked>
                                                <label class="form-check-label" for="cbOT">Over Time</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(function () {
        $('.btn-get-data').on('click',function () { 
            ...
            let cbPresent = $('#cbPresent:checked').val();
            let cbAbsent = $('#cbAbsent:checked').val();
            let cbLate = $('#cbLate:checked').val();
            let cbOT = $('#cbOT:checked').val();

            let url = "<?php echo route('reports/attendance/monthly_attendance_result'); ?>";
            $.get(url,{EmployeeCode,Department, Designation, Section, StaffCategory, FromDate, ToDate, cbCode, cbName, cbDoj,
                  cbDesignation, cbSection, cbDepartment,cbStaffCat,cbPresent,cbAbsent,cbLate,cbOT },function (data) {
