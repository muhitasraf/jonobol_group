...
<div class="content-wrapper">
    ...
    <section class="content pt-2 pb-0">
        <div class="container-fluid">
            ...
            <form action="<?php echo route("company/save");?>" class="role" enctype="multipart/form-data" method="post">
                <div class="row">
                    <!-- left column -->
                    <div class="col-md-10">
                        <!-- card -->
...
<!--                            </div>-->
                            <div class="card-body">
                                <div class="form-group mb-2">
                                    ...
                                    <?php echo form_input('name','text',old('name'),'class="form-control form-control-sm" id="CompanyName" placeholder="Type name" accept="image" required'); ?>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea name="address" class="form-control form-control-sm" rows="2" id="address" placeholder="Type address" required></textarea>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <?php
                                        echo form_input('logo','file',null,$attribute='class="form-control" placeholder="Attach logo" id="logo" required accept="image/jpg"');
                                    ?>
                                    <?php
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <?php echo form_input('local_name','text',old('local_name'),'class="form-control form-control-sm keyboard" id="local_name" placeholder="Type local name" autocomplete="off" data-toggle="modal" data-target="#myModal"'); ?>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea name="local_address" class="form-control form-control-sm keyboard" rows="2" id="local_address" placeholder="Type local address" autocomplete="off" data-toggle="modal" data-target="#myModal"></textarea>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <?php echo form_input('owner_name','text',old('owner_name'),'class="form-control form-control-sm" id="owner_name" placeholder="Type owner name"'); ?>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <?php echo form_input('office_phone','text',old('office_phone'),'class="form-control form-control-sm" id="office_phone" placeholder="Type office phone"'); ?>
                                </div>
                                <div class="form-group mb-2">
                                    <label class="m-0" for="user_name">Web Address</label>
                                    <?php echo form_input('web_address','text',old('web_address'),'class="form-control form-control-sm" id="web_address" placeholder="Type web address"'); ?>
                                </div>
                                <div class="form-group mb-2">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <?php
                                        echo form_input('from_date','text',date('d-m-Y') ,$attribute='class="form-control-sm form_date mr-2" placeholder="Leave Year Start Date" id="from_date" autocomplete="off" readonly');
                                        ?>
                                    ...
                                    <?php
                                        echo form_input('to_date','text',date('d-m-Y'),$attribute='class="form-control-sm form_date" placeholder="Leave Year End Date" id="to_date" autocomplete="off" readonly');
                                    ?>
                                ...
                                <div class="form-group mb-2 row">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input is_active" id="IsActive" value="1" name="IsActive">
